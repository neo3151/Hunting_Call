...
void main() {
  ...
  group('Quick Match Scoring — Realistic Scenarios', skip: 'Refactored', () {
  ...
  group('Quick Match Scoring — Weight Sensitivity', skip: 'Refactored', () {
  ...
  group('Quick Match Scoring — Edge Cases', skip: 'Refactored', () {
  ...
  group('Quick Match Scoring — Discrimination', skip: 'Refactored', () {

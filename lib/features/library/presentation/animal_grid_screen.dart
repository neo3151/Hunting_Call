...
class AnimalGridScreen extends ConsumerWidget {
  ...
  static const Map<String, String> _animalImages = {
    ...
    'Rocky Mountain Elk': 'assets/images/animals/elk.jpg',
    'Whitetail Deer': 'assets/images/animals/whitetail_buck.jpg',
    'Fallow Deer': 'assets/images/animals/fallow_deer.jpg',
    'Mule Deer': 'assets/images/animals/mule_deer.jpg',
    'Wild Hog': 'assets/images/animals/wild_hog.jpg',
    ...
    'Gray Wolf': 'assets/images/animals/gray_wolf.jpg',
    'Bobcat': 'assets/images/animals/bobcat.jpg',
    'Puma': 'assets/images/animals/puma.jpg',
    'Wild Turkey': 'assets/images/animals/turkey.jpg',
    'Barred Owl': 'assets/images/animals/barred_owl.jpg',
    'Bobwhite Quail': 'assets/images/animals/quail.jpg',
    'Ring-Necked Pheasant': 'assets/images/animals/pheasant.jpg',
    'American Woodcock': 'assets/images/animals/woodcock.jpg',
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final categoryCalls = category == 'All'
        ? allCalls
        : allCalls.where((c) => c.category == category).toList();
              ...
              : Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final colors = _categoryGradients[animalCategory] ??
                          gradientColors;

...
const worlds = [
  ...
  WorldInfo(
    ...
    bgColorBot: Color(0xFF06121A),
    pathColor: Color(0xFF455A64),
    pathBorder: Color(0xFF37474F),
    treeColors: [Color(0xFF004D40), Color(0xFF00695C), Color(0xFF00796B)],
    groundColors: [Color(0xFF263238), Color(0xFF37474F), Color(0xFF006064)],
  ),
  WorldInfo(
    name: 'FLYWAY',
    ...
    bgColorTop: Color(0xFF0A1A2E),
    bgColorBot: Color(0xFF06101A),
    pathColor: Color(0xFF546E7A),
    pathBorder: Color(0xFF455A64),
    treeColors: [Color(0xFF0D47A1), Color(0xFF1565C0), Color(0xFF1976D2)],
    groundColors: [Color(0xFF1A237E), Color(0xFF283593), Color(0xFF0277BD)],
  ),
  WorldInfo(
    name: 'THE RIDGE',
    subtitle: 'Big Game',

...
/// On-device AI coaching powered by Google Gemini 2.0 Flash.
///
...
class AiCoachService {
  ...
  ///
  /// Calls Gemini 2.0 Flash directly with the species-specific system prompt.
  /// Falls back to rule-based coaching if offline, no API key, or any error.
